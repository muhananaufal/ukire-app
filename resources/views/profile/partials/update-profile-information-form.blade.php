    ...
    <div class="grid grid-cols-1 md:grid-cols-3">
        <div class="p-6 md:p-8 border-b md:border-b-0 md:border-r border-gray-200">
            <div class="flex flex-col items-center md:items-start text-center md:text-left">
                {{-- Avatar Profil --}}
                <div class="flex-shrink-0 h-20 w-20 rounded-full bg-amber-500 text-white flex items-center justify-center text-3xl font-bold">
                    {{ Auth::user()->initials }}
                </div>
                <div class="mt-4">
        ...
        <div class="md:col-span-2 p-6 md:p-8">
            ...
            <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                ...
                <div>
                    <x-forms.floating-input name="name" label="Nama" type="text" :value="old('name', $user->name)" required autofocus />
