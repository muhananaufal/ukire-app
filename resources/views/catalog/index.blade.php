                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <select name="sort" id="sort"
                                ...
                                <option value="price_asc" @selected(request('sort') == 'price_asc')>Harga: Terendah ke Tertinggi
                                </option>
                                <option value="price_desc" @selected(request('sort') == 'price_desc')>Harga: Tertinggi ke Terendah
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            <main class="lg:col-span-3">
                <div class="pb-4 border-b border-gray-200">
                    <p class="text-sm text-gray-600">
                        Menampilkan <span
                            class="font-semibold">{{ $products->firstItem() }}-{{ $products->lastItem() }}</span> dari
                        <span class="font-semibold">{{ $products->total() }}</span> hasil
                    </p>
                </div>
                ...
                <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8">
                    ...
                    @empty
                        <div class="col-span-full text-center py-16">
                            ...
                            <p class="mt-2 text-gray-500">Coba ubah atau hapus filter Anda untuk melihat hasil lainnya.
                            </p>
